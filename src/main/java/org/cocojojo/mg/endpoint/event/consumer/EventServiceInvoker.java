package org.cocojojo.mg.endpoint.event.consumer;
...
import org.cocojojo.mg.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("org.cocojojo.mg.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "org.cocojojo.mg.service.event."
